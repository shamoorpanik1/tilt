package com.example.pankaj.getwidgets;
...
public class MainActivity1 extends AppCompatActivity {
    ...
    private void setupWidget() {
        appWidgetManager = AppWidgetManager.getInstance(MainActivity1.this);
        appWidgetHost = new LauncherAppWidgetHost(MainActivity1.this, APPWIDGET_HOST_ID);
    }
    ...
    public void selectWidget() {
        ...
        Log.e("Main", "Allocated widget id = " + appWidgetId + " " + pickIntent);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.e("Main", "onActivityResult(int requestCode=" + requestCode + ", int resultCode=" + resultCode + ", Intent data=" + data + ")");
    ...
    public void createWidget(Intent data) {
        ...
        Log.e(TAG, "appid -----" + appWidgetId);
        LauncherAppWidgetInfo launcherInfo = new LauncherAppWidgetInfo(appWidgetId);
        launcherInfo.setHostView(getAppWidgetHost().createView(MainActivity1.this, appWidgetId, appWidgetInfo));

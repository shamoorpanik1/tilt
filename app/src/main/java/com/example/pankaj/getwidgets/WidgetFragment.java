...
public class WidgetFragment extends Fragment {
    ...
    private void bindDesktopItems (ArrayList<ItemInfo> appWidgets, boolean isRefresh, BinderCallback callback) {
        ...
        MainActivity1 main = (MainActivity1) getActivity();
        if ( main == null ) {
    ...
    class BindWidgetTask extends AsyncTask<ArrayList<ItemInfo>, ItemInfo, LinkedList<ItemInfo>> {
        MainActivity1 main = null;
        boolean isRefresh = false;
        private LinkedList<ItemInfo> mItemInfos;

        public BindWidgetTask (MainActivity1 main, boolean isRefresh) {
            this.main = main;
    ...
    private void checkToAddWidget () {
        ...
        if ( !sharedPrefs.contains("widgetpage-" + screen + "-checkToAddWidget") ) {
            ...
            MainActivity1 m = (MainActivity1) getActivity();
    ...
    public void addProvider (MainActivity1 m, AppWidgetHost host, AppWidgetManager manager, AppWidgetProviderInfo provider) {
        ...
        if ( success ) {
            ...
            m.startActivityForResult(intent, MainActivity1.REQUEST_BIND_APPWIDGET);
        }
